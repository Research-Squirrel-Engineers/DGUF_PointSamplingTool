...
In archaeology, the analysis of site factors of settlements and the correlation of sites and geographic conditions (land use, elevation, slope, accessibility, etc.) are questions that have been pursued with cartographic methods for more than 100 years [@grunwald_2016]. These investigations can nowadays be carried out almost seamlessly with the help of Geographic Information Systems. In many cases, e.g. if a site size is unknown [@miera_2020, 103], queries for the distribution of certain factors, such as soil type or land use are already useful if employed on the simplest geometric features - points.
